...
<body onload="loadSession()">
  <nav class="navbar">
    ...
    <ul>
      <li><a class="links" id="sign-in-btn" href="./register.php">Sign In</a></li>
      <li><a class="links" id="sign-up-btn" href="./login.php">Sign Up</a></li>
      ...
      <li><a class="links" id="logout-btn" href="./login.php">Logout</a></li>
    </ul>
  </nav>
</body>
</html>
